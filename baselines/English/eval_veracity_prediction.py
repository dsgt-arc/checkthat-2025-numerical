...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_path", type=str, default="data/raw_data/test_claims_quantemp.json", help="Path to the test data")
    parser.add_argument(
        "--output_path", type=str, default="output/finqa_roberta_claimdecomp_test.csv", help="Path to the output predictions"
    )
    parser.add_argument("--category", type=str, default="statistical", help="The class of claims to report results for")
    parser.add_argument("--category_wise", type=bool, default=False, help="should classwise filtering be applied")
    ...
    ground_truth_data = read_claims_data(CONFIG["test_path"], CONFIG["category"], CONFIG["category_wise"])
    ...
    # MAX
    claimdecomp_unified["verdict"] = claimdecomp_unified["verdict"].map(
        {"Half True/False": "Conflicting", "False": "False", "True": "True"}
    )
