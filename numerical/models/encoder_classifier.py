...
class BaseClassifier(nn.Module):
    ...
    def save(self, save_path: str):
        ...
        torch.save(
            {
                "model_name": self.encoder.config._name_or_path if hasattr(self, "encoder") else self.mbc.config._name_or_path,
    ...
    @classmethod
    def load(cls, load_path: str) -> "BaseClassifier":
...
class Classifier(BaseClassifier):
    ...
    def __init__(
        ...
        # Store freeze_encoder str in instance attr for saving
